...
-- --------------------------------------------------------------------
drop table am_ant_sys;
drop table am_augs;
drop table am_eng_data;
drop table am_towers;
drop table amcmnts;
drop table ant_make;
drop table ant_pattern;
drop table app_party;
drop table app_tracking;
drop table application;
drop table call_sign_history;
drop table dtv_agreement_group;
drop table dtv_allotment;
drop table dtv_channel_assignments;
drop table dtv_facility;
drop table dtv_transition;
drop table elevation_ant_make;
drop table elevation_pattern;
drop table elevation_pattern_addl;
drop table fac_party;
drop table facility;
drop table fm_app_indicators;
drop table fm_eng_data;
drop table frn_history;
drop table fmcmnts;
drop table gen_app_indicators;
drop table if_notification;
drop table int_translator;
drop table intl_tracking;
drop table lic_app_indicators;
drop table nce_factors;
drop table ownership_capitalization;
drop table ownership_contract;
drop table ownership_exemptions;
drop table ownership_group;
drop table ownership_interests;
drop table ownership_other_int;
drop table ownership_other_int_xml_data;
drop table ownership_relationships;
drop table ownership_report;
drop table ownership_structure;
drop table party;
drop table positional_int;
drop table supp_facility;
drop table tv_app_indicators;
drop table tv_eng_data;
...
efficiency_restricted	float(),
efficiency_theoretical	float(),
...
field_ratio	float(),
hag_no_obst	float(),
hgt_overall_mtr	float(),
hgt_rad_ab	float(),
hgt_radiator_mtr	float(),
...
op_power_level	float(),
op_population_perc	float(),
...
field_value80	float(),
field_value90	float(),
field_value100	float(),
field_value110	float(),
field_value120	float(),
field_value130	float(),
field_value140	float(),
field_value150	float(),
field_value160	float(),
field_value170	float(),
field_value180	float(),
field_value190	float(),
field_value200	float(),
field_value210	float(),
field_value220	float(),
field_value230	float(),
field_value240	float(),
field_value250	float(),
field_value260	float(),
field_value270	float(),
field_value280	float(),
field_value290	float(),
field_value300	float(),
field_value310	float(),
field_value320	float(),
field_value330	float(),
field_value340	float(),
field_value350	float(),
elevation_antenna_id	int, NOT NULL,
last_update_date	datetime
);
